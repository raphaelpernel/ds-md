...
import { OrderRecap } from '@/components/product/Checkout/OrderRecap'
import { PaymentForm } from '@/components/product/Checkout/PaymentForm'
  ...
  return (
    <main className="proto-page">
      <header className="proto-header">
        <Link href="/slot" className="proto-back">← Modifier le créneau</Link>
