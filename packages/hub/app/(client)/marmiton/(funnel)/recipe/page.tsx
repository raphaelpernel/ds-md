...
import { RecipeIngredientWidget, ViewToggle } from '@/features/marmiton-prototype/components/product/RecipeIngredientWidget/RecipeIngredientWidget'
import type { ViewMode } from '@/features/marmiton-prototype/components/product/RecipeIngredientWidget/RecipeIngredientWidget'
import { RecipeOrderBanner } from '@/features/marmiton-prototype/components/product/RecipeIngredientWidget/RecipeOrderBanner'
import { Heart, ShareNetwork } from '@phosphor-icons/react'
import { Button, Stepper, Drawer } from '@mealz-product-team/design-system'
import { Cart } from '@/features/marmiton-prototype/components/product/Cart/Cart'
import { CartFooter } from '@/features/marmiton-prototype/components/product/Cart/CartFooter'
import { RecipeAskBar } from '@/features/marmiton-prototype/components/product/RecipeAskBar/RecipeAskBar'
import { RecipeAgentDrawer } from '@/features/marmiton-prototype/components/agent/RecipeAgentDrawer'
import { buildRecipeChips } from '@/features/marmiton-prototype/lib/recipeAskScript'
import { useCart } from '@/features/marmiton-prototype/context/CartContext'
import { getRecipeById } from '@/features/marmiton-prototype/data/mock/recipes'
      ...
      <Drawer
        ...
        footer={
          <CartFooter
            ...
            mode="view"
            onViewCart={() => { setDrawerOpen(false); router.push('/marmiton/cart') }}
            onChangeStore={() => router.push('/marmiton/store')}
          />
        }
      >
        <Cart
          onChooseStore={() => { setDrawerOpen(false); router.push('/marmiton/store') }}
          onChangeStore={() => { setDrawerOpen(false); router.push('/marmiton/store') }}
        />
      </Drawer>
