...
import { OrderRecap } from '@/features/marmiton-prototype/components/product/Checkout/OrderRecap'
import { PaymentForm } from '@/features/marmiton-prototype/components/product/Checkout/PaymentForm'
import { SegmentedControl } from '@mealz-product-team/design-system'
...
export default function PaiementPage() {
  ...
  const handleConfirm = async () => {
    ...
    setLoading(false)
    router.push('/marmiton/confirmation')
  }

  return (
    <main className="proto-page">
      <header className="proto-header">
        <Link href="/marmiton/slot" className="proto-back">← Modifier le créneau</Link>
