...
export function ChatComposer() {
  ...
  return (
    <div className="assistant-shopping-chat-composer">
      <div className="assistant-shopping-chat-composer__inner">
        <div className="assistant-shopping-chat-composer__suggestions">
        ...
        <div className="assistant-shopping-chat-composer__field">
          <input
            className="assistant-shopping-chat-composer__input"
            type="text"
            value={value}
