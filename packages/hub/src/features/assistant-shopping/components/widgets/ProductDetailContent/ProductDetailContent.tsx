import type { Product } from '@/features/assistant-shopping/data/types/product'
...
import { getProductOrigin, getProductPackaging, getProductStorage, getProductSupplierAddress } from '@/features/assistant-shopping/lib/productDetails'
