...
export function interpretMessage(raw: string): Interpretation {
  ...
  if (includesAny(normalized, OFFTOPIC_KEYWORDS)) {
    return { intent: 'offtopic', contextSentence: 'Je suis là pour vous aider à trouver des recettes ou faire vos courses — je ne peux pas répondre à cette question.' }
  }
